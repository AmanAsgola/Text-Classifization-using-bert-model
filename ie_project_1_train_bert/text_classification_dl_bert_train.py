...
# Load dataset
print()
dataset = load_jsonl_file("/content/shared_data/dataset_1_sliced.jsonl")
...
with mlflow.start_run(run_name="My Custom Run"):
  ...
  torch.save(model.state_dict(), '/content/models/bert_model_exp_1.pth')
...
plt.ylabel('Loss')
plt.legend()
plt.savefig('/content/shared_images/bert_model_losses.png')
